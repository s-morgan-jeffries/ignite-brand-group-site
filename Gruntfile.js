...
//        'cssFormat': 'json',
        ...
        'cssTemplate': 'lib/sprite_positions.styl.mustache'
    ...
    wiredep: {
      src: {
        ...
        exclude: [
          ...
          '<%= yeoman.src %>/bower_components/bootstrap/',
          '<%= yeoman.src %>/bower_components/bootstrap-hover-dropdown/'
        ],
