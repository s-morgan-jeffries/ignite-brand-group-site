...
var simpleGallery_navpanel={
	loadinggif: 'portfolio/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'portfolio/left.gif', 'portfolio/play.gif', 'portfolio/right.gif', 'portfolio/pause.gif'], //nav panel images (in that order)
